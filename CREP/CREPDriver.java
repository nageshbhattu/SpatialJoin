...
public class CREPDriver 
{
    public enum MyCounters{
        REPLICATED, PROJECTED, AFTER_REPLICATION;
    }
    public static void main(String[] args) throws Exception 
    {
        ...
        conf.setEnum("REPLICATED", MyCounters.REPLICATED);
        conf.setEnum("AFTER_REPLICATION", MyCounters.AFTER_REPLICATION);
        conf.setEnum("PROJECTED", MyCounters.PROJECTED);
        ...
        job.setJarByClass(CREPDriver.class);
        ...
        if (success) 
        {
           ...
           // job1.getCounters().findCounter(MyCounters.REPLICATED).getValue();
           // job1.getCounters().findCounter(MyCounters.TOTAL).getValue();
        }
    }
}	