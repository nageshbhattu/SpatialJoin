...
public class CREPDriver 
{
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        if (success) 
        {
            ...
            FileInputFormat.addInputPath(job1, new Path("hdfs://172.27.35.70/"+args[1]+"/part*"));
           ...
           // job.getCounters().findCounter(MyCounters.OVERLAP_COUNT).getValue();
