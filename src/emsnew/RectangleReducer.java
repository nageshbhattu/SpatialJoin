...
{   
                        ...
                        if (overlaps)
                        {
                            ...
                            for (int l = 0; l < ld.size(); l++)
                            {
                                ...
                                if (overlaps)
                                {
                                    ...
                                    {   
                                    //    int cr = 0;
                                       // la.remove(i); lb.remove(j); lc.remove(k); ld.remove(l);
  ...
  //      System.out.println("Largest Y  \t"+r);
    ...
    public void cleanup(Context context) throws IOException, InterruptedException {
        ...
        System.out.println("-------------------------------------------");
        System.out.println("EMSNew R1 IDr1 :" + context.getTaskAttemptID().getTaskID()+ "Reducer Time--:"+startr1);
        System.out.println("-------------------------------------------");
    }   
}