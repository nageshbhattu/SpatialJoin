...
public class JoinTupleNew  implements Writable, Comparable<JoinTupleNew>{
   ...
   // int count;
    ...
    public JoinTupleNew( int JoinType, int r1RowNum, int r1RelationIndex, double r1x1, double r1y1, double r1x2, double r1y2,
    ...
    public JoinTupleNew(JoinTupleNew jt ) {
    //	this.count = jt.count;
    ...
    @Override
    public int compareTo(JoinTupleNew arg0) {
