...
public class RectangleReducer extends Reducer<LongWritable, Rectangle, LongWritable, Text>
{
    ...
    public void joinABCD(double cellWidth, int CellNumber, int cellRow, int cellCol, int cellsPerRow, int cellsPerCol, ArrayList<Rectangle> la, ArrayList<Rectangle> lb, ArrayList<Rectangle> lc, ArrayList<Rectangle> ld, Rectangle cellRect, Reducer<LongWritable, Rectangle, LongWritable, Text>.Context context) throws java.io.IOException, InterruptedException
    {
        ...
        boolean[] raa = new boolean[la.size()];
        boolean[] rbb = new boolean[lb.size()];
        boolean[] rcc = new boolean[lc.size()];
        boolean[] rdd = new boolean[ld.size()];
                            ...
                            for (int l = 0; l < ld.size(); l++)
                            {
                                ...
                                if (overlaps)
                                {
                                    ...
                                    {   
                                        ...
                                        String r11 =  r1.rowNum +","+ r2.rowNum +","+ r3.rowNum +","+ r4.rowNum ;
                                        //context.write(new LongWritable(key2), new Text(r11));
                                        mos.write(new LongWritable(key2), new Text(r11), check0);
                                        double xx1=findLargestX2(r1,r2,r3,r4);
                                        double yy1=findLargestY2(r1,r2,r3,r4);
                                        if(cellRect.x1<=xx1 && cellRect.x2>xx1 && cellRect.y1<=yy1 && cellRect.y2>yy1)
                                        {
                                            raa[i] = true; rbb[j] = true; rcc[k] = true; rdd[l] = true;
                                        }
                                    }
                                    else{
                                        ra[i] = true;
        ...
        int key1; int joinType1 = 1; int joinType2 =2; int joinType3 = 3;
            ...
            if(!(raa[i] == true)){
                ...
                for(int j=0; j<lb.size(); j++){
                    if(!(rbb[j] == true)){
                        ...
                        overlaps =checkOverlap(r1,r2);
                        if (overlaps){
                            String r11 =  ","+joinType1 +","+ r1.rowNum +","+ r1.relationIndex +","+ r1.x1 +","+ r1.y1 +","+ r1.x2 +","+ r1.y2 +","+r2.rowNum +","+ r2.relationIndex +","+ r2.x1 +","+ r2.y1 +","+ r2.x2 +","+ r2.y2;
            ...
            if(!(rbb[i] == true)){
                ...
                for(int j=0; j<lc.size(); j++){
                    if(!(rcc[j] == true)){
                        ...
                        overlaps =checkOverlap(r1,r2);
                        if (overlaps){
                            String r11 =  ","+joinType2 +","+ r1.rowNum +","+ r1.relationIndex +","+ r1.x1 +","+ r1.y1 +","+ r1.x2 +","+ r1.y2 +","+r2.rowNum +","+ r2.relationIndex +","+ r2.x1 +","+ r2.y1 +","+ r2.x2 +","+ r2.y2;
                            context.write(new LongWritable(key1), new Text(r11));
                        }
                    }
                }
            ...
            if(!(rcc[i] == true)){
                ...
                for(int j=0; j<ld.size(); j++){
                    if(!(rdd[j] == true)){
                        ...
                        overlaps =checkOverlap(r1,r2);
                        if (overlaps){
                            String r11 =  ","+joinType3 +","+ r1.rowNum +","+ r1.relationIndex +","+ r1.x1 +","+ r1.y1 +","+ r1.x2 +","+ r1.y2 +","+r2.rowNum +","+ r2.relationIndex +","+ r2.x1 +","+ r2.y1 +","+ r2.x2 +","+ r2.y2;
                            context.write(new LongWritable(key1), new Text(r11));
                        }
                    }
                }
    ...
    double findLargestX2(Rectangle r1, Rectangle r2, Rectangle r3, Rectangle r4) 
    {
     //     System.out.println(r1.toString() +"\t"+ r2.toString()+"\t"+ r3.toString()+"\t"+r4.toString());
        double x=0;
    ...
    //      System.out.println(x);
        return x;   // It will Return Right Most rectangle's  x2 point
    }
    double findLargestY2(Rectangle r1, Rectangle r2, Rectangle r3, Rectangle r4) 
    {
        double y=0;
  ...
  //      System.out.println("Largest Y  \t"+r);
        ...
        return y;   // It will Return Upper Most rectangle's  y2 point
    }
    ...
    public void cleanup(Context context) throws IOException, InterruptedException {
        ...
        System.out.println("-------------------------------------------");
        System.out.println("EMSMain R1 IDr1 :" + context.getTaskAttemptID().getTaskID()+ "Reducer Time--:"+startr1);
        System.out.println("-------------------------------------------");
    }
}