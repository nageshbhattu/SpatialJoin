...
public class Rectangle  implements Writable, Comparable<Rectangle>{
	...
	public Rectangle(int crossed, int rowNum, int relIndex,double x1, double y1, double x2,double y2) {
		this.rowNum = rowNum;
	...
	public String toString() {
		return crossed +","+ rowNum + "," +relationIndex+"," + x1 + ","+y1 + "," + x2 + ","+y2;
	}
