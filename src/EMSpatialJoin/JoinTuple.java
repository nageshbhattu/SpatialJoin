...
public class JoinTuple  implements Writable, Comparable<JoinTuple>{
	...
	public JoinTuple(int JoinType, int r1RowNum, int r1RelationIndex, double r1x1, double r1y1, double r1x2, double r1y2,
	...
	@Override
	public int compareTo(JoinTuple arg0) {
