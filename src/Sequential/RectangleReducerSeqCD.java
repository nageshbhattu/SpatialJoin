                                    ...
                                    Context context) throws IOException, InterruptedException 
    {
        for (int i = 0; i < lc.size(); i++) 
        {
           ...
           //     System.out.println(r2.r3x1 +"<="+ r1.r1x1 +">"+r2.r3x2);
                ...
                if (r1.r3x1 <= r2.r1x1 && r1.r3x2 >= r2.r1x1 && r1.r3x2 < r2.r1x2) {
                             //       System.out.println("Case 1: LB ITEM" + r2.toString());

                    if (r1.r3y1 <= r2.r1y1 && r1.r3y2 > r2.r1y1 && r2.r1y2 > r1.r3y2) {
                        overlaps = true;
                        oxl = r2.r1x1;
                        oyb = r2.r1y1;
                        oxr = r1.r3x2;
                    ...
                    else if (r1.r3y1 <= r2.r1y1 && r1.r3y2 > r2.r1y1 && r2.r1y2 <= r1.r3y2) {
                        overlaps = true;
                        oxl = r2.r1x1;
                        oyb = r2.r1y1;
                        oxr = r1.r3x2;
                    ...
                    else if (r1.r3y1 <= r2.r1y2 && r1.r3y2 > r2.r1y2 && r2.r1y1 < r1.r3y1) {
                        overlaps = true;
                        oxl = r2.r1x1;
                        oyb = r1.r3y1;
                        oxr = r1.r3x2;
                    ...
                    else if (r1.r3y2 < r2.r1y2 && r2.r1y1 < r1.r3y1) {
                        overlaps = true;
                        oxl = r2.r1x1;
                        oyb = r1.r3y1;
                        oxr = r1.r3x2;
                ...
                else if (r2.r1x1 <= r1.r3x1 && r2.r1x2 >= r1.r3x1 && r2.r1x2< r1.r3x2)//changed from (r1.x1 <= r2.x2 && r1.x2 > r2.x2 ) to 
                                                                          //(r2.x1 <= r1.x1 && r2.x2 > r1.x1 && r2.x2<= r1.x2)
                {     //            System.out.println("Case 2: LB ITEM" + r2.toString());
                     //               System.out.println("Case 2: LB ITEM" + r1.toString());
                        if (r1.r3y1 <= r2.r1y1 && r1.r3y2 > r2.r1y1 && r2.r1y2 > r1.r3y2) {
           ...
           //                         System.out.println("Case 2:2 LB ITEM" + r2.toString());
                            ...
                            oxr = r2.r1x2;
                            oyt = r2.r1y2;
                        } else if (r2.r1y1 < r1.r3y1 && r2.r1y2 > r1.r3y1) {
                        ...
                        else if (r1.r3y1 <= r2.r1y2 && r1.r3y2 > r2.r1y2 && r2.r1y1 <= r1.r3y1) {//I changed from r2.y1 < r1.y1  to r2.y1 <= r1.y1
                            overlaps = true;
                            oxl = r1.r3x1;
                            oyb = r1.r3y1;
                            oxr = r1.r3x2;
                        ...
                        if (r1.r3y1 >= r2.r1y1 && r1.r3y1 < r2.r1y2 && r2.r1y2 < r1.r3y2) {
                            overlaps = true;
                            oxl = r2.r1x1;
                            oyb = r1.r3y1;
                            oxr = r2.r1x2;
                            oyt = r2.r1y2;
                        } else if (r2.r1y1 <= r1.r3y1 && r1.r3y1 < r2.r1y2 && r1.r3y2 <= r2.r1y2) {
                            overlaps = true;
                            oxl = r2.r1x1;
                            oyb = r1.r3y1;
                            oxr = r2.r1x2;
                        ...
                        else if (r1.r3y1 <= r2.r1y1 && r1.r3y2 > r2.r1y1 && r1.r3y2 <= r2.r1y2) { 
                            overlaps = true;
                            oxl = r2.r1x1;
                            oyb = r2.r1y1;
                            oxr = r2.r1x2;
                            oyt = r1.r3y2;
                        } else if (r1.r3y1 < r2.r1y1 && r1.r3y2 > r2.r1y1) {
                            overlaps = true;
                            oxl = r2.r1x1;
                            oyb = r2.r1y1;
                            oxr = r2.r1x2;
