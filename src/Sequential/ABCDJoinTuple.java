...
public class ABCDJoinTuple  implements Writable, Comparable<ABCDJoinTuple>{
	 ...
	 */
	public ABCDJoinTuple() {
		
	}
	public ABCDJoinTuple(int JoinType, int r1RowNum, int r1RelationIndex, double r1x1, double r1y1, double r1x2, double r1y2,
	...
	@Override
	public int compareTo(ABCDJoinTuple arg0) {
	...
	public void write(DataOutput out) throws IOException {
		...
		out.writeDouble(r3y2);
                out.writeDouble(r4x1);
		out.writeDouble(r4x2);
		out.writeDouble(r4y1);
		out.writeDouble(r4y2);
	}
	@Override
